    ...
    <div class="grid-container">
        ...
        <aside id="sidebar">
            ...
            <ul class="sidebar-list">
                ...
                <li class="sidebar-list-item">
                    <a href="verproductos.php"><span class="material-icons-outlined">inventory_2</span> Ver productos</a>
                </li>
                <li class="sidebar-list-item">
                <a href="addProduct.html"><span class="material-icons-outlined">add</span> Agregar producto</a>
                </li>
                <li class="sidebar-list-item">
